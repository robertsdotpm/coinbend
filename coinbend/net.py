            ...
            if self.passive != None:
                ...
                for s in r:
                    if s == self.passive: 
                        ...
                        if len(self.inbound) == self.max_inbound:
                            print("Quit 1")
                            print(str(len(self.inbound)))
                            print(str(self.max_inbound))
                            try:
            ...
            if len(self.inbound) < self.max_inbound:
                ...
                if self.rendezvous.server_con != None:
                    for reply in self.rendezvous.server_con:
                        ...
                        #Quit
                        if len(self.inbound) == self.max_inbound:
                            print("Sending quit to the server.")
                            print(str(len(self.inbound)))
                            print(str(self.max_inbound))
                            if self.rendezvous.server_con != None:
                ...
                """
                    ...
                    print(e)
                    print("Unknown exception occured in synchronize.")
                """
